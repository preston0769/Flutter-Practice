...
class FirstScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
        ...
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: new Text("Sign up".toUpperCase(),style: TextStyle(color: Color(0xEE333333), fontSize: 16.0,fontWeight: FontWeight.w500,letterSpacing: 2.0),),
        ),
        body: Container(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: new Text(
                          ...
                          style: TextStyle(
                              color: Color(0xEEEEEEEE), fontSize: 12.0),
                        ),
                      ),
                    ],
                  ),
